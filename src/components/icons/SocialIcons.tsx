export default function SocialIcons() {
  return (
    <div className="flex space-x-4">
      {/* Instagram */}
      <a
        href="https://www.instagram.com/gabrieel.amaraal/"
        target="_blank"
      ...
      <a
        ...
        target="_blank"
        className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-gray-600 transition"
      >
        <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          <path
            fill-rule="evenodd"
